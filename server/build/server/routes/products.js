...
// GET all products
dbProductsRouter.get('/', async (_req, res) => {
    try {
...
dbProductsRouter.get('/new', async (_req, res) => {
    try {
...
dbProductsRouter.get('/featured', async (_req, res) => {
    try {
...
dbProductsRouter.get('/category/:slug', async (req, res) => {
    try {
...
dbProductsRouter.get('/:slug', async (req, res) => {
    try {
        const { slug } = req.params;
